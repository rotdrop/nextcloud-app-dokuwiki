OC.L10N.register(
    ...
    "Please enter the location of the already installed DokuWiki instance. This should either be an absolute path or relative to the root of the web browser, or a complete URL which points to the web location of the DokuWiki. In order to make things work your have to enable the XML-RPC protocol in your DokuWiki." : "Geben Sie den Webseitenpfad der bereits installierten DokuWiki-Instanz ein. Dies sollte entweder der absolute Pfad oder relativ zum Root des Webbrowsers sein oder einer komplette URL, welche auf Webseitenpfad zeigt. Damit das funktioniert, muss das XML-RPC-Protokoll in DokuWiki aktiviert werden.",
