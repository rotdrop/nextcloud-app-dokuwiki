OC.L10N.register(
    ...
    "Disable SSL verification, e.g. for self-signed certificates or known mis-matching host-names like 'localhost'." : "SSL doğrulamasını kapatın. Kendinden imzalı sertifikalar ya da 'localhost' gibi uygun olmayan sunucu adları için gerekir.",
    "Enable SSL verification." : "SSL doğrulaması kullanılsın",
    "The initial navigation failed. This is likely a bug in this app." : "İlk gezinme yapılamadı. Bu uygulamada bir sorun var gibi görünüyor.",
    "DokuWiki Wrapper for Nextcloud" : "Nextcloud için DokuWiki sarmalayıcısı",
