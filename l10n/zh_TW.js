OC.L10N.register(
    ...
    "DokuWiki" : "DokuWiki",
    "Embed an existing DokuWiki instance into Nextcloud, potentially with SSO." : "將現有的 DokuWiki 站台嵌入至 Nextcloud 中，可能使用 SSO。",
    ...
    "Please enter the location of the already installed DokuWiki instance. This should either be a path, absolute or relative to the root of the web server, or a complete URL pointing to the web location of the DokuWiki. In order to make things work, your have to enable the XML-RPC protocol in your DokuWiki." : "請輸入已安裝的 DokuWiki 站台的位置。這應該是到網路伺服器根目錄的絕對或相對路徑，或是指向 DokuWiki 的網路位置的完整 URL。為了讓事情正常運作，您必須在您的 DokuWiki 中啟用 XML-RPC 協定。",
