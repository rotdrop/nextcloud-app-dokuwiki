  ...
  <SettingsSection :class="[...cloudVersionClasses, appName]" :title="t(appName, 'DokuWiki Integration')">
    <AppSettingsSection title="">
      <SettingsInputText v-model="externalLocation"
                         ...
                         title=""
                         :hint="t(appName, 'Please enter the location of the already installed DokuWiki instance. This should either be an abolute path relative to the root of the web-browser, or a complete URL which points to the web-location of the DokuWiki. In order to make things work your have to enable the XMLRPC protocol in your DokuWiki.')"
                         :disabled="loading > 0"
